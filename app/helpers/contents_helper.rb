  ...
  def file_type(content)
     case content.content_type
       ...
       when /x-apple-diskimage/
         image_tag("dmg.png", :style => 'float:left;', :class => "img_preview", :id => content.id) + content_tag(:div, link_to(content.name, project_content_path(@project, content)), :class => "content_name")
       when /zip/
         image_tag("zip.png", :style => 'float:left;', :class => "img_preview", :id => content.id) + content_tag(:div, link_to(content.name, project_content_path(@project, content)), :class => "content_name")
       when /x-msdos-program/
         image_tag("exe.png", :style => 'float:left;', :class => "img_preview", :id => content.id) + content_tag(:div, link_to(content.name, project_content_path(@project, content)), :class => "content_name")
       when /officedocument.spreadsheetml.sheet/
         image_tag("xls.png", :style => 'float:left;', :class => "img_preview", :id => content.id) + content_tag(:div, link_to(content.name, project_content_path(@project, content)), :class => "content_name")
       else
         image_tag("default2.png", :style => 'float:left;', :class => "img_preview", :id => content.id) + content_tag(:div, link_to(content.name, project_content_path(@project, content)), :class => "content_name")
     end
  end
end
